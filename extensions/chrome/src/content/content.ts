...
function createResultsPanel(): void {
  ...
  console.log('[Chrome] Results panel created and visible');
}
...
function setupFileMonitoring() {
  console.log('[Chrome] Setting up file monitoring...');
  
  const fileInputs = document.querySelectorAll('input[type="file"]');
  console.log('[Chrome] Found', fileInputs.length, 'file inputs');
  ...
  console.log('[Chrome] File monitoring setup complete');
}
